                        ...
                        <div class="card overflow-hidden card-bg-fill">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-4 fs-14">Sorry, the create account page is under construction and cannot be used now, but don't worry as soon as the create account page can be used, thank you.</p>
                                    <button type="button" class="btn btn-success btn-border" onclick="window.location.reload()">
