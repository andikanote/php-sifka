                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="index.php">
                                <i class="ri-honour-line"></i> <span data-key="t-dashboard">Dashboard</span>
                            </a>
                                ...
                                <div class="collapse menu-dropdown mega-dropdown-menu" id="sideCategory">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <li class="nav-item">
                                                    <a href="" class="nav-link" data-key="t-alerts">List Category</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="" class="nav-link" data-key="t-alerts">Add Category</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="collapse menu-dropdown mega-dropdown-menu" id="sideTransaction">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                    <a href="" class="nav-link" data-key="t-alerts">List Transaction</a>
                                                </li>
                                                <li class="nav-item">
